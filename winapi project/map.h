...
typedef struct {
    ...
    RECT* item_brick_collision_rects; 
    int num_item_brick_collisions; 
...
int map_check_collision(Map* map, int x, int y, int width, int height, int* collision_index); // 충돌 체크 함수
